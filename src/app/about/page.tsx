  ...
  return (
    <div>
      ...
      <div className={style.container}>
        ...
        <hr />
        <p className={style.text}>Maximumは、<span className={style.highlight}>国際大学対抗プログラミングコンテスト（ICPC）</span>へ参加し、</p>
        <p className={style.text}>良い成績を上げるために成立したプログラミング研究会です。</p>
        <p className={style.text}>2022年度からは、<span className={style.highlight}>競技プログラミング</span>のみならず、</p>
        <p className={style.text}><span className={style.highlight}>Web</span>や<span className={style.highlight}>その他プログラミング</span>の知識を高める活動を行っています。</p>
        <p className={style.title}>競技プログラミング</p>
        <hr />
        <p>活動内容</p>
        <p className={style.text}>国際大学対抗プログラミングコンテスト(ICPC)に参加し、</p>
        <p className={style.text}>良い成績を上げるための活動を行っています。</p>
        <p className={style.text}>具体的には、ICPCなどの各種プログラミングコンテストへの参加、</p>
        <p className={style.text}>週2回の勉強会などを行っています。</p>
        <img />
        <p>競技プログラミングとは？</p>
        <p className={style.text}>皆さんご存じの通り、コンピュータはとても高速に計算してくれます。</p>
        <p className={style.text}>しかし、その速さには限界があり、世界中の多くの問題は</p>
        ...
        <p className={style.text}>プログラムとして記述するのが競技プログラミングです。</p>
        <p></p>{/*スペースを空けるためのもの*/}
        <p className={style.text}>工学部情報工学科のパンフレットに記載していただきました！</p>
        <p className={style.text}>
        ...
        <p className={style.text}>そこに出場することを目標にトレーニングもします。</p>
        <p className={style.text}>詳しく知りたい方は大会参加記を見てみてください。</p>
      </div>
    </div>
  );
}
